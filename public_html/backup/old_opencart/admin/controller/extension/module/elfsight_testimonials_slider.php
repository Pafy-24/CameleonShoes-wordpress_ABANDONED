...
class Deactivate {
    ...
    public function __construct($data) {
        ...
        $this->app_slug = 'testimonials-slider';
        $this->app_name = 'Testimonials Slider';
    ...
    public function setDeactivateReasons() {
        return require ( (__DIR__) . '/testimonials-slider-assets/reasons.php' );
    }
...
class ControllerExtensionModuleElfsightTestimonialsSlider extends Controller {
    private $error = array();

    public $params = NULL;

    const ELFSIGHT_EMBED_URL = 'https://apps.elfsight.com/embed/testimonials-slider/?utm_source=portals&utm_medium=opencart&utm_campaign=testimonials-slider&utm_content=sign-up';

    public function index() {
        $this->load->language('extension/module/elfsight_testimonials_slider');
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
            $this->model_setting_setting->editSetting('module_elfsight_testimonials_slider', $this->request->post);
        ...
        $data['action'] = $this->url->link('extension/module/elfsight_testimonials_slider', 'user_token=' . $this->session->data['user_token'], true);

        $data['cancel'] = $this->url->link('marketplace/extension', 'user_token=' . $this->session->data['user_token'] . '&type=module', true);

        if (isset($this->request->post['module_testimonials_slider_status'])) {
            $data['module_testimonials_slider_status'] = $this->request->post['module_testimonials_slider_status'];
        } else {
            $data['module_testimonials_slider_status'] = $this->config->get('module_testimonials_slider_status');
        }

        $data['header'] = $this->load->controller('common/header');
        $data['column_left'] = $this->load->controller('common/column_left');

        $this->response->setOutput($this->load->view('extension/module/elfsight_testimonials_slider', $data));
    }

    protected function validate() {
        if (!$this->user->hasPermission('modify', 'extension/module/elfsight_testimonials_slider')) {
    ...
    public function setDeactivateReasons() {
        return require ( './controller/extension/module/testimonials-slider-assets/reasons.php' );
    }
    ...
    public function uninstall() {
        ...
        include './controller/extension/module/testimonials-slider-assets/popup.php';
    }
    ...
    public function sendRequest($type) {
        ...
        $data['app_name'] = 'TestimonialsSlider';
