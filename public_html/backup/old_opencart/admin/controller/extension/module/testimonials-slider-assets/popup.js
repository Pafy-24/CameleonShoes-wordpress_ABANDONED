(function($) {
    ...
    let $deactivateForm  = jQuery('#testimonials-slider-deactivateForm');
    ...
    let deactivateFormSubmitted = localStorage.getItem('testimonials-slider-deactivateFormSubmitted');
    ...
    function submitForm(deactivate_options, id) {
        ...
        data.push({name: 'action', value: 'testimonials-slider-deactivate'});
        ...
        if (!deactivateFormSubmitted) {
            localStorage.setItem('testimonials-slider-deactivateFormSubmitted', true);
            deactivateFormSubmitted = true;

            jQuery.post('./controller/extension/module/elfsight_testimonials_slider.php', jQuery.param(data)).then(function(result) {
