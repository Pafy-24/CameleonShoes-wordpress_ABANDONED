<link rel="stylesheet" href="./controller/extension/module/testimonials-slider-assets/popup.css">

<div class="eapps-deactivation-popup-overlay"></div>

<div class="eapps-deactivation-popup">
    <form method="post" id="testimonials-slider-deactivateForm" action="">
        <div class="eapps-deactivation-popup-header">
            <div class="eapps-deactivation-popup-header-heading">You have succesfully uninstalled Elfsight Testimonials Slider</div>
...
<script>
    ...
    node.async = true;
    node.src = './controller/extension/module/testimonials-slider-assets/popup.js';
